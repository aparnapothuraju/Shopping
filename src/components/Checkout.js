...
const Checkout = () => {
  ...
  // console.log(addresses.all,newAddress.value)
  ...
  return (
    <>
      <Header hasHiddenAuthButtons loggedIn={token} />
      <Grid container>
              ...
              {addresses.all.length > 0 &&
                addresses.all.map((address) => (
                  <Box
                    ...
                    border={3}
                    borderColor={
                      addresses.selected === address._id ? "#00A278" : "#ddd"
                    }
                    backgroundColor={
                      addresses.selected === address._id ? "#E9F5E1" : "white"
                    }
                    mt={1}
                  >
